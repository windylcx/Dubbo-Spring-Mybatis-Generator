    ...
    _createClass(App, [{
        ...
        value: function init() {
            ...
            $('.generate').click(function (e) {
                ...
                try {
                    ...
                    if (config['tables_sql'].trim() !== "") {
                        var list = config['tables_sql'].match(/(CREATE TABLE|create table) (.*) \(/g);
                        var tables = [];
                        list.forEach(function (item) {
                            var table = item.replace(/CREATE TABLE/g, "").replace(/\(/g, "").replace(/`/g, "").trim();
                            console.log(table);
                            tables.push(table);
                        });
                        config["tables"] = tables.join(",");

                        var sql = $("#tables_sql").val().trim().replace(/^#.*$/gm, "").replace(/\/\*.*\*\/;/g, "").replace(/\n/g, "");
                    ...
                    $.ajax({
                        type: "POST",
                        url: "generate?client_id=" + _user2.default.getClientId(),
                        ...
                        success: function success(data) {
                            ...
                            var url = "download?client_id=" + _user2.default.getClientId() + "&id=" + data + "&name=" + (config["name"] ? config["name"] : "test");
            ...
            $(".file-upload").on('change', function (e) {
                ...
                var upload = new _upload2.default($(e.target).attr("name"), file);
                upload.doUpload();
            });
        ...
        value: function loadDefaultConfig() {
            $.ajax("load_config?client_id=" + _user2.default.getClientId()).then(function (config) {
                ...
                $.get('tpl/template.mst', function (template) {
...
},{"./upload.js":20,"./user.js":21,"bootstrap":1,"jquery":14,"mustache":15}],20:[function(require,module,exports){
"use strict";
...
var Upload = function () {
    ...
    _createClass(Upload, [{
        ...
        value: function doUpload(type) {
            ...
            $.ajax({
                type: "POST",
                url: "upload?client_id=" + _user2.default.getClientId() + "&key=" + this.key,
                xhr: function xhr() {
                ...
                error: function error(_error) {
                    // handle error
                    console.log("upload fail", _error);
                },
                async: true,
                data: formData,
                cache: false,
...
},{"./user.js":21,"jquery":14}],21:[function(require,module,exports){
'use strict';
