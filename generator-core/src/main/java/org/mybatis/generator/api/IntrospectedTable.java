...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		ATTR_BASE_COLUMN_LIST_ID, ATTR_BLOB_COLUMN_LIST_ID,
		ATTR_MYBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID, ATTR_MYBATIS3_SQL_PROVIDER_TYPE ,
		/**/
		ATTR_LIST_QUERY_STATEMENT_ID,
		ATTR_SEARCH_QUERY_STATEMENT_ID,
	}
	...
	public void setListQueryId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_LIST_QUERY_STATEMENT_ID,s);
	}

	public String getListQueryId() {
		return internalAttributes.get(InternalAttribute.ATTR_LIST_QUERY_STATEMENT_ID);
	}

	public void setSearchQueryId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_LIST_QUERY_STATEMENT_ID,s);
	}
